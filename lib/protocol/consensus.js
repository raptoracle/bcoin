...
exports.BASE_REWARD = 50 * 100 * exports.COIN;
...
const getMaxBlockSize = function getMaxBlockSize(fDIP0001Active = true) {
  return fDIP0001Active ? exports.MAX_DIP0001_BLOCK_SIZE : exports.MAX_LEGACY_BLOCK_SIZE;
};

const getMaxBlockSigOps = function getMaxBlockSigOps(fDIP0001Active = true) {
  return getMaxBlockSize(fDIP0001Active) / 50;
};

exports.MAX_BLOCK_SIZE = getMaxBlockSize();
...
exports.MAX_BLOCK_SIGOPS = getMaxBlockSigOps();
