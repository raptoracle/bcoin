...
exports.GetSporksPacket = require('./packets/getsporks.js');
exports.SporkPacket = require('./packets/spork.js');
...
exports.fromRaw = function fromRaw(cmd, data) {
  switch (cmd) {
    ...
    case 'getsporks':
      return exports.GetSporksPacket.fromRaw(data);
    case 'spork':
      return exports.SporkPacket.fromRaw(data);
    default:
