...
bcoin.define('Amount', './units/amount');
bcoin.define('URI', './uri/uri');
...
bcoin.define('consensus', './blockchain/params/consensus');
bcoin.define('Network', './protocol/network');
bcoin.define('networks', './blockchain/params/networks');
bcoin.define('policy', './blockchain/params/policy');
