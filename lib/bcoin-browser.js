...
bcoin.Amount = require('./units/amount');
bcoin.URI = require('./uri');
...
bcoin.consensus = require('./blockchain/params/consensus');
bcoin.Network = require('./protocol/network');
bcoin.networks = require('./blockchain/params/networks');
bcoin.policy = require('./blockchain/params/policy');
