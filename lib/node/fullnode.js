...
class FullNode extends Node {
  ...
  constructor(options) {
    ...
    this.indexFull = this.config.bool('index-full');
    this.indexTX = this.indexFull || this.config.bool('index-tx');
    this.indexAddress = this.indexFull || this.config.bool('index-address');
    ...
    this.mongo = {
      enabled: this.config.bool('mongo', false),
      dbName: this.config.str('db-name', `${process.title}-${this.network.type}`),
