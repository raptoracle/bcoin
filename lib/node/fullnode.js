...
class FullNode extends Node {
  ...
  constructor(options) {
    ...
    this.mongo = this.config.bool('mongo', false);
    this.mdbName = this.config.str('mdb-name', `${this.title}-${this.network.type}`);
    this.mdbHost = this.config.str('mdb-host', 'localhost');
