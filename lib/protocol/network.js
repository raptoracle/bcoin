...
class Network {
  ...
  constructor(options) {
    ...
    this.type = options.type; // main, testnet etc.
    this.seeds = options.seeds; // array of seed hosts
    this.magic = options.magic; //0x.....  hex entry of magic
    this.port = options.port; // protocol port (NOT RPC)
