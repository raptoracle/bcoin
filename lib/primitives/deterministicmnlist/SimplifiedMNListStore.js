 ...
 * @alias module:primitives.deterministicmnlist.SimplifiedMNListStore
...
class SimplifiedMNListStore {
   ...
   */
  getSMLDiffbyHeightRange(startHeight, endHeight) {
   ...
   * @returns {SimplifiedMNList}
   */
  createListFromBaseAndDiffs(diffs) {
