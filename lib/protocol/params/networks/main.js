...
main.nSuperblockStartBlock = consensus.INT_MAX; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
main.nSuperblockStartHash = '';
main.nSuperblockCycle = 16616; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725

main.vSporkAddresses = ['RWGvGpd3yJdnfh9ziyHNDEoHMJBvnZ23zK'];
main.nMinSporkKeys = 1;
main.fBIP9CheckSmartnodesUpgraded = true;

main.defaultFounderAddress = "RTtyQU6DoSuNWetT4WUem5qXP5jNYGpwat";
main.rewardStructures = [{ height: consensus.INT_MAX, percentage: 5}];

// smart nodes
main.nSmartnodePaymentsStartBlock = 5761; //
main.nSmartnodePaymentsIncreaseBlock = 158000; // actual historical value
main.nSmartnodePaymentsIncreasePeriod = 576 * 30; // 17280 - actual historical value

// smart node collaterals
main.collaterals = [
  {height: 88720, amount: 600000 * consensus.COIN},
  {height: 132720, amount: 800000 * consensus.COIN},
  {height: 176720, amount: 1000000 * consensus.COIN},
  {height: 220720, amount: 1250000 * consensus.COIN},
  {height: 264720, amount: 1500000 * consensus.COIN},
  {height: consensus.INT_MAX, amount: 1800000 * consensus.COIN}
];

 // smart node rewards
main.rewardPercentages = [
  {height: 5761, percentage: 0},
  {height: consensus.INT_MAX, percentage: 20}
];

main.futureRewardShare = {
  smartnode: 0.8,
  miner: 0.2,
  founder: 0.0
};
...
main.llmqs[llmq.LLMQ_TYPES.LLMQ_TYPE_50_60] = llmq.llmq3_60;
main.llmqs[llmq.LLMQ_TYPES.LLMQ_TYPE_400_60] = llmq.llmq20_60;
main.llmqs[llmq.LLMQ_TYPES.LLMQ_TYPE_400_85] = llmq.llmq20_85;
main.llmqs[llmq.LLMQ_TYPES.LLMQ_TYPE_100_67] = llmq.llmq100_67_mainnet;

main.llmqTypeChainLocks = llmq.LLMQ_TYPES.LLMQ_TYPE_400_60;
main.llmqTypeInstantSend = llmq.LLMQ_TYPES.LLMQ_TYPE_50_60;
main.llmqTypePlatform = llmq.LLMQ_TYPES.LLMQ_TYPE_100_67;
