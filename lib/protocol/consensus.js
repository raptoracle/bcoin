...
exports.getMaxBlockSize = function getMaxBlockSize(fDIP0001Active = true) {
  return fDIP0001Active ? exports.MAX_DIP0001_BLOCK_SIZE : exports.MAX_LEGACY_BLOCK_SIZE;
};

exports.getMaxBlockSigOps = function getMaxBlockSigOps(fDIP0001Active = true) {
...
exports.getBlockSubsidy = function getBlockSubsidy(prevHeight) {
  ...
  return new BN(Math.floor(subsidy)).imul(new BN(exports.COIN));
};
