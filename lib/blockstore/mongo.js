/*!
 * blockstore/mongo.js - mongo blockstore for bcoin
 ...
 * Mongo Block Store
 *
 * @alias module:blockstore:MongoBlockStore
 * @abstract
 */

class MongoBlockStore extends AbstractBlockStore {
  /**
  ...
  async open() {
    this.logger.info('Opening MongoBlockStore...');
  ...
  async close() {
    this.logger.info('Closing MongoBlockStore...');
...
module.exports = MongoBlockStore;
